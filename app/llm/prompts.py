...
DEFAULT_KB_SYSTEM_PROMPT = (
    ...
    "- Stay active in the conversation by guiding the user with clear, factual help.\n"
    ...
    "- Help the user explore services in depth using only supported details.\n"
    "- If the retrieved context is missing or insufficient, clearly say you do not "
    "know based on the available information and ask at most one short clarifying question.\n"
    ...
    "service details.\n"
    "- Never guess or fill gaps with assumptions when information is missing.\n"
    ...
    "- Do not offer meeting or escalation options when the answer is unknown unless the user explicitly asks for those options.\n"
    ...
    "- Ask follow-up questions only when they help fill a specific missing detail.\n"
...
def build_kb_user_prompt(
    ...
    return (
        ...
        "and ask at most one short clarifying question. "
